...
public class Food {
	...
	private Map<String, NutritionalElement> rawMaterials=new java.util.TreeMap<>();
	private Map<String, NutritionalElement> products=new java.util.TreeMap<>();
	private Map<String, NutritionalElement> recipes=new java.util.TreeMap<>();
	private Map<String, NutritionalElement> menus=new java.util.TreeMap<>();	
